...
const directoryData: DirectoryData = {
  ...
  featuredPlaces: [],
  brands: [
    { id: "brand-1", name: "McDonald's", slug: "mcdonalds", description: "", placeIds: ["place-1"], placeCount: 1 }
  ],
  neighbourhoods: [
    { id: "area-1", name: "Mandai", slug: "mandai", description: "", placeIds: ["place-1"], placeCount: 1 }
  ],
  malls: [
    { id: "mall-1", name: "Singapore Zoo", slug: "singapore-zoo", description: "", placeIds: ["place-1"], placeCount: 1 }
  ],
  mrtStations: [
    {
      id: "mrt-1",
      name: "Woodlands South MRT",
      slug: "woodlands-south-mrt",
      description: "",
      placeIds: ["place-1"],
      placeCount: 1
    }
...
describe("sitemap", () => {
  ...
  it("generates a sitemap index document that points to the URL sitemap", () => {
    const sitemap = buildSitemapIndexXml(["https://halalcrowd.sg/sitemap-0.xml"]);

    expect(sitemap).toContain("<sitemapindex");
    expect(sitemap).toContain("<sitemap><loc>https://halalcrowd.sg/sitemap-0.xml</loc></sitemap>");
